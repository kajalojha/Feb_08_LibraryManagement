...
public class Library_Management {
    ...
    private static void addbooks(Library l, Scanner sc) {
        ...
        Library_Management.books book = new Library_Management().new books(id, title, category, author, isbn);
        l.additems(book);
    ...
    private static void addmagazine(Library l, Scanner sc) {
        ...
        Library_Management.Magazines m = new Library_Management().new Magazines(id, title, category, author, issueno);
        l.additems(m);
        System.out.println("    Book added successfully!!!");
        System.out.println("    Press any key....");
        sc.nextLine();
